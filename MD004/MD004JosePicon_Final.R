...
#data was not loading directly from RStudio, uploading from Github repo 

data = read.csv("https://raw.githubusercontent.com/josepicon/R-Course/main/sentiment_dataset.csv", stringsAsFactors=F)
head(data, 10)
